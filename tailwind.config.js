  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        qoherentpurple: theme.colors.default.text_color.qoherentpurple,
        qoherentpink: theme.colors.default.text_color.qoherentpink,
        qoherentblue: theme.colors.default.text_color.qoherentblue,
